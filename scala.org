...
*** TODO try building Saddle in Scala 2.(13,12)
curl https://raw.github.com/paulp/sbt-extras/master/sbt > ~/bin/sbt
*** TODO ask if WR doesn't work for Scala 2.11
When I use Scala 2.11.5,
I can use null, define a list of mixed types, etc.
